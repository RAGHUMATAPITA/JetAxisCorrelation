...
// apply cent bin and vertx z weight
...
TString jet_trigger;
TString PbPb_jet_trigger = "HLT_HICsAK4PFJet80Eta1p5_v1"; 
...
string pp_JEU_file_data = "JEC_files/Spring18_ppRef5TeV_V6_DATA_Uncertainty_AK4PF.txt";
string PbPb_JEU_file_data = "JEC_files/Autumn18_HI_V8_DATA_Uncertainty_AK4PF.txt";
