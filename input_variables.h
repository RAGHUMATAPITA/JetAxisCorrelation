...
float leading_pT_min = 120.0; // leaading jet min pt cut
float leading_pT_max = 500.0; // leaading jet max pt cut

float subleading_pT_min = 120.0; // subleaading jet min pt cut
float subleading_pT_max = 500.0; // subleaading jet max pt cut
...
TString JER_File;
TString JER_File_pp = "PbPb_JERFitFunc_Nominal_NoTrigger_NoWeight_pThat15_JetpT40_1000_akCs4PF_CentBin3"; // for ak4PF Jets
...
// from histogram 
//TString EWTA_File_DEtaPhi_pp = "/eos/user/r/rpradhan/Research/ATUIC/JetAxisCorrAna/new_Ana_3Nov/PbPb_AODMC_CentBin160_JetTrigger80_CentVzpTWeight_AppliedEvtFilter_NoJERCorrectiononGen_2DGenRecoMatched_pThat50_JetpT40_1000_ExtrapTBin_IncludeDetaDPhi_0p001BinWidth_MatchedHighetGenRecopT_EWTAResolution.root";
//TString EWTA_File_DEtaPhi_PbPb = "/eos/user/r/rpradhan/Research/ATUIC/JetAxisCorrAna/new_Ana_3Nov/PbPb_AODMC_CentBin160_JetTrigger80_CentVzpTWeight_AppliedEvtFilter_NoJERCorrectiononGen_2DGenRecoMatched_pThat50_JetpT40_1000_ExtrapTBin_IncludeDetaDPhi_0p001BinWidth_MatchedHighetGenRecopT_EWTAResolution.root";

//TString EWTA_File_DEtaPhi_pp = "PbPb_DRHist_pTbin_CentBin_Nominal_JetTrigger80_CentVzWeight_pThat50_JetpT40_1000_akCs4PF.root";
//TString EWTA_File_DEtaPhi_PbPb = "PbPb_DRHist_pTbin_CentBin_Nominal_JetTrigger80_CentVzWeight_pThat50_JetpT40_1000_akCs4PF.root";

//TString EWTA_File_DEtaPhi_pp = "PbPb_DRHistRatio_pTbin_CentBin_Nominal_JetTrigger80_CentVzWeight_pThat50_JetpT40_1000_akCs4PF.root";
//TString EWTA_File_DEtaPhi_PbPb = "PbPb_DRHistRatio_pTbin_CentBin_Nominal_JetTrigger80_CentVzWeight_pThat50_JetpT40_1000_akCs4PF.root";

//TString EWTA_File_DEtaPhi_pp = "PbPb_DR_E_WTA_gen_reco_pTbin_CentBin_Nominal_JetTrigger80_CentVzWeight_pThat50_akCs4PF.root";
//TString EWTA_File_DEtaPhi_PbPb = "PbPb_DR_E_WTA_gen_reco_pTbin_CentBin_Nominal_JetTrigger80_CentVzWeight_pThat50_akCs4PF.root";
