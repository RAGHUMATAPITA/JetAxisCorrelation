...
int bins_DR_gn_rc_ratio[ndim_DR_gn_rc_ratio]   =      { 500,  jtpT_nbins,        8 , NCentbin        };
double xmin_DR_gn_rc_ratio[ndim_DR_gn_rc_ratio]   =   { 0.,  0.,                 0., 0.              };
double xmax_DR_gn_rc_ratio[ndim_DR_gn_rc_ratio]   =   { 5.,  (double)jtpT_nbins, 8., (double)NCentbin};
...
int bins_DEtaPhi_E_gn_rc[ndim_DEtaPhi_E_gn_rc]   =      {  401,   50,         8 , NCentbin         ,  32};
...
int bins_DEtaPhi_WTA_gn_rc[ndim_DEtaPhi_WTA_gn_rc]   =      {  641,   50,         8 , NCentbin        ,  32};
